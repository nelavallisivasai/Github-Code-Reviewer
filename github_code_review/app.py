...
def app():
    ...
    with utils.TempDirContext(temp_dir):
        st.set_page_config(
            page_title="Github Code Review",
        )

        session_state = st.session_state

        st.title("Github Code Review :rocket:")

        with st.expander("About Github Code Review"):
            st.markdown(about.about_section, unsafe_allow_html=True)
            st.write("")

        default_repo_url = "https://github.com/nelavallisivasai/HR_Bot_Langraph.git"
